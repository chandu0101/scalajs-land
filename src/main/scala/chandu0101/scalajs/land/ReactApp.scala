package chandu0101.scalajs.land

import chandu0101.scalajs.land.routes.AppRouter
...
//      dom.navigator.serviceWorker.register("/scalajs-land/offline.js").andThen((resp: ServiceWorkerRegistration) => {
